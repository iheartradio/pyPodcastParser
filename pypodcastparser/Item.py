...
class Item(object):
    ...
    def set_itunes_episode(self, tag):
        ...
        try:
            ...
            if -32767 >= int(self.itunes_episode) or int(self.itunes_episode) >= 32767 or self.itunes_episode == None:
    ...
    def set_itunes_season(self, tag):
        ...
        try:
            ...
            if -32767 >= int(self.itunes_season) or int(self.itunes_season) >= 32767 or self.itunes_season == None:
